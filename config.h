...
static Shortcut shortcuts[] = {
	...
	{ MODKEY,               XK_m,           zoom,           {.f = +1} }, /** `MODKEY + `m` instead of `TERMMOD` + `K` because SHIFT+ALT changes language */
	{ MODKEY,               XK_n,           zoom,           {.f = -1} }, /** `MODKEY` + `n` instead of `TERMMOD` + `J` because SHIFT+ALT changes language */
